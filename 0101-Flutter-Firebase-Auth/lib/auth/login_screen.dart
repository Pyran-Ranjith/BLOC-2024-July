...
import 'package:flutter_firebase_modal/auth/signup_screen.dart';
import 'package:flutter_firebase_modal/screens/home_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(child: const Text("0101: Login Screen")),
